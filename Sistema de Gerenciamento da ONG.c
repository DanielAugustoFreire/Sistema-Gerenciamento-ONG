			...
			if(codigo==0){
				...
				if(pos==-1)
					...
					if(deseja=='S')
					{
						...
						printf("\nExcluido...\n");
						//RetirarHoras(codigo); com essa função ativada nao funciona a exclusao do projeto
						system("pause");
					}
				}
			}
...
//Não Consegui Retirar as horas do registro pois quando esta função esta ativada o Dev simplesmente nao apagar e nem renomeia essa func, nao sei por que
